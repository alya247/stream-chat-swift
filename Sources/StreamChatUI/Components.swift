...
public struct _Components<ExtraData: ExtraDataTypes> {
    ...
    public var scrollToLatestMessageButton: _ScrollToLatestMessageButton<ExtraData>.Type = _ScrollToLatestMessageButton<ExtraData>.self

    /// The view that shows a number of unread messages on the Scroll-To-Latest-Message button in the Message List.
    public var messageListUnreadCountView: _ChatMessageListUnreadCountView<ExtraData>.Type = _ChatMessageListUnreadCountView<ExtraData>.self
